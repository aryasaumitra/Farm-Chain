...
class AddReview extends StatefulWidget {
    ...
    AddReview({Key key,@required this.orderDetail}):super(key:key);
  @override
  _AddReviewState createState() => _AddReviewState(this.orderDetail);
}

class _AddReviewState extends State<AddReview> {
    OrderDetail orderDetail;

    _AddReviewState(OrderDetail orderDetail){
...
//                                                        1.0),
    ...
    _onSubmit() async{
        ...
        if(_cropReviewKey.currentState.validate()){
            ...
            var val=await Order.addReview(authToken: userProfile.authToken, data: data);
            //API CODE
            print('\nVal:'+val.toString());
