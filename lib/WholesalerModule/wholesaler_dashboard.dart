...
class WholesalerDashboard extends StatefulWidget {
  @override
  _WholesalerDashboardState createState() => _WholesalerDashboardState();
}
                                  ...
                                  Padding(
                                          ...
                                          child: Material(
                                              ...
                                              child: InkWell(
                                                  onTap: (){
                                                      ...
                                                      Navigator.pushNamed(context, '/wholesalerCropSearch');
                                                  },
                                                  child: Container(
                                                      height: 80.0,
                                                      child: Row(
                                   ...
                                   Padding(
                                          ...
                                          child: Material(
                                              ...
                                              child: InkWell(
                                                  onTap: (){
                                                     Navigator.pushNamed(context, '/wholeSalerStocks');
                                                  },
                                                  child: Container(
                                                      height: 80.0,
                                                      child: Row(
                                   ...
                                   Padding(
                                          ...
                                          child: Material(
                                              ...
                                              child: InkWell(
                                                  onTap: (){
                                                      Navigator.pushNamed(context, '/wholesalerOrders');
                                                  },
                                                  child: Container(
                                                      height: 80.0,
                                                      child: Row(
