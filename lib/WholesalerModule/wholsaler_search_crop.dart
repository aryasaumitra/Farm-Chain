...
import 'package:agro_chain/WholesalerModule/wholesaler_buy_crop.dart';
...
class WholesalerCropSearch extends StatefulWidget {
  @override
  _WholesalerCropSearchState createState() => _WholesalerCropSearchState();
}

class _WholesalerCropSearchState extends State<WholesalerCropSearch> {
...
//                                                            );
                                                            Navigator.push(context, MaterialPageRoute(
                                                                builder: (context)=>WholesalerBuyCrop(productDetail: snapshot.data[index])
                                                            ));
                                                        },
                                                        child: Container(
                                                            height: 40.0,
