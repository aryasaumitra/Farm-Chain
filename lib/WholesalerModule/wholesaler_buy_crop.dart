...
class WholesalerBuyCrop extends StatefulWidget {
    //final WholesalerCropDetail wholesalerCropDetail;
    final ProductDetail productDetail;

    WholesalerBuyCrop({Key key, @required this.productDetail}):super(key:key);
  @override
  _WholesalerBuyCropState createState() => _WholesalerBuyCropState(this.productDetail);
}

class _WholesalerBuyCropState extends State<WholesalerBuyCrop> {

   // WholesalerCropDetail wholesalerCropDetail;
    ProductDetail productDetail;

    _WholesalerBuyCropState(ProductDetail productDetail){
