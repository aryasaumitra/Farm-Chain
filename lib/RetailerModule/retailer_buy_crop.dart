...
class RetailerBuyCrop extends StatefulWidget {

    final ProductDetail productDetail;

    RetailerBuyCrop({Key key, @required this.productDetail}):super(key:key);
  @override
  _RetailerBuyCropState createState() => _RetailerBuyCropState(this.productDetail);
}

class _RetailerBuyCropState extends State<RetailerBuyCrop> {
    ProductDetail productDetail;
    final GlobalKey<FormBuilderState> _cropBuyKey=GlobalKey<FormBuilderState>();
    _RetailerBuyCropState(ProductDetail productDetail){
