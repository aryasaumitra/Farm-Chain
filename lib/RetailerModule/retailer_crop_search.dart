...
class RetailerCropSearch extends StatefulWidget {
  @override
  _RetailerCropSearchState createState() => _RetailerCropSearchState();
}

class _RetailerCropSearchState extends State<RetailerCropSearch> {
...
//                                                            );
                                                                Navigator.push(context, MaterialPageRoute(
                                                                    builder: (context)=>RetailerBuyCrop(productDetail: snapshot.data[index])
                                                                ));
                                                            },
                                                            child: Container(
                                                                height: 40.0,
